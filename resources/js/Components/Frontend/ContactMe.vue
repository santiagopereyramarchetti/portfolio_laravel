  ...
  <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
    ...
    >
        <div class="flex flex-col items-center text-center">
            ...
            <p class="subtitle">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae blanditiis nostrum nisi necessitatibus unde nulla nihil temporibus. Accusamus optio, dignissimos obcaecati nihil, sequi, fugit distinctio odio consequatur maiores iure minus.
            </p>
        </div>
            ...
            <div class="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
                <div class="flex flex-col lg:flex-row gap-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-accent font-normal">Email me at jhon@doe.com</p>
                    </div>
                </div>
                <div class="flex flex-col lg:flex-row gap-x-4">
                    <div class="text-accent rounded-sm w-14 h-14 flex items-start justify-center mt-2 mb-4 lg:mb-0 text-2xl">
            ...
            <form class="space-y-8 w-full max-w-md" @submit.prevent="submit">
                ...
                <div class="flex gap-8">
                    <div>
                        ...
                        <span class="text-small m-2 text-red-400">{{ form.errors.name }}</span>
                    </div>
                    <div>
                        <input v-model="form.email" type="email" class="input" placeholder="Your Email" />
                        <span class="text-small m-2 text-red-400">{{ form.errors.email }}</span>
                    </div>
                </div>
                <textarea v-model="form.body" class="textarea" placeholder="Your Message" spellcheck="false"></textarea>
                <span class="text-small m-2 text-red-400">{{ form.errors.body }}</span>
