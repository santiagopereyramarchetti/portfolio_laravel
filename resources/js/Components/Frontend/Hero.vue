    ...
    <div class="container mx-auto h-full">
        <div class="flex flex-col md:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                ...
                <p class="pt-4 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-left">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ducimus laudantium voluptatibus unde dolorum nesciunt atque nisi veritatis! Iste laudantium excepturi voluptatibus corporis nesciunt qui, a repudiandae itaque, consequuntur odio saepe!
                </p>
                ...
                <div class="pt-12">
                    ...
                    <div class="flex items-center mb-6">
                        <a href="#" class="w-12 h-12 rounded-full flex items-center justify-center border border-white text-dark hover:bg-light-secondary hover:border-light-secondary dark:hover:bg-secondary dark:hover:border-secondary mr-3 sm:mr-4">
                            <svg
                                width="8"
                                height="16"
                                viewBox="0 0 8 16"
            ...
            <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
                <img class="rounded-lg" src="/storage/img/hero.jpg" alt="">
            </div>
        </div>
    </div>
  </section>
