    ...
    >
      <div class="-mx-4 flex flex-wrap items-center">
        <div class="w-full px-4 lg:w-1/2">
          <span class="mb-2 text-base font-semibold text-gray-500">
            Find Your Next Dream App
          </span>
          <h2
            class="mb-6 text-3xl font-bold leading-tight text-gray-500 sm:mb-8 sm:text-[38px] lg:mb-0"
          >
            Lets us <br class="xs:block hidden" />
            To do it!
          </h2>
        </div>
        <div class="w-full px-4 lg:w-1/2">
